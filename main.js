...
const FASTFLAG_PRESETS = {
  ...
  showFps: {
    ...
    hint: 'Muestra un contador de FPS dentro de Roblox.',
  },
  perfBias: {
    category: 'performance',
    key: 'DFIntGraphicsOptimizationModePerformanceBiasPercent',
    type: 'int',
    label: 'Sesgo de rendimiento',
    hint: 'Más alto = prioriza FPS sobre calidad (100 = todo rendimiento).',
    default: 100,
  },
  perfScale: {
    category: 'performance',
    key: 'DFIntGraphicsOptimizationModePerformanceScalePercent',
    type: 'int',
    label: 'Escala de rendimiento',
    hint: 'Ajusta la resolución interna según el rendimiento (100 = máximo).',
    default: 100,
  },
  frameRateTarget: {
    category: 'performance',
    key: 'DFIntGraphicsOptimizationModeFRMFrameRateTarget',
    type: 'int',
    label: 'Objetivo FPS (optimizador)',
    hint: 'El optimizador apunta a este FPS (igual que desbloquear FPS).',
    default: 240,
  },
  minFrameTime: {
    category: 'performance',
    key: 'DFIntGraphicsOptimizationModeMinFrameTimeTargetMs',
    type: 'int',
    label: 'Frame time mínimo (ms)',
    hint: 'Cuánto como mínimo por frame (bajo = más FPS).',
    default: 4,
  },
  maxFrameTime: {
    category: 'performance',
    key: 'DFIntGraphicsOptimizationModeMaxFrameTimeTargetMs',
    type: 'int',
    label: 'Frame time máximo (ms)',
    hint: 'Tope de tiempo por frame antes de bajar calidad.',
    default: 16,
  },
  physFps: {
    category: 'performance',
    key: 'DFIntPhysicsStepLimitMaxFPS',
    type: 'int',
    label: 'Límite FPS de física',
    hint: 'Desacopla la física del FPS (más FPS sin más carga).',
    default: 240,
  },
  physSteps: {
    category: 'performance',
    key: 'DFIntPhysicsStepsPerSecond',
    type: 'int',
    label: 'Pasos de física por segundo',
    hint: 'Menos pasos = menos CPU (60 es el mínimo recomendado).',
    default: 60,
  },
  lod: {
    category: 'effects',
    key: 'DFIntSlimForceLOD',
    type: 'int',
    label: 'Forzar LOD bajo (modo cartón)',
    hint: '0 = calidad alta, 3 = calidad mínima (máximo FPS, se ve feo).',
    default: 3,
  },
  ssao: {
    category: 'effects',
    key: 'FFlagSSAO',
    type: 'bool',
    label: 'Desactivar SSAO',
    hint: 'Apagado = sin oclusión ambiental (más FPS).',
  },
  mtu: {
    category: 'network',
